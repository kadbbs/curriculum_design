...
//            System.out.print("  ");
    ...
    public static Object[][] select(String a) {
        ...
        try {
            ...
            conn = DriverManager.getConnection(DB_URL, "root", "hkk85n5z");
            stmt = conn.createStatement();
            String sql = "select topic.top_id ,topic.top_name,topic.meaning,topic.content,topic.skill,te.te_name\n" +
                    "from te,topic\n" +
                    "where te.te_id=topic.te_id";
            rs = stmt.executeQuery(sql);
...
//            System.out.print("\n");
            ...
            while (rs.next()) {
                ...
                // String te_id=rs.getString(7);

                for (l = 0; l < 6; l++) {

                    rowData[k][l] = rs.getString(l + 1);
                }
                k=k+1;
//                for (k=0;k<rs.getRow();k++){
//                    for (l = 0; l < 6; l++) {
//
//                        rowData[k][l] = rs.getString(l + 1);
//                    }
